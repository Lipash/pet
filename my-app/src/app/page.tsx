  ...
  return (
    <div className="p-3 sm:p-0 dark:bg-greyText ">
      <div className="dark:bg-greyText h-full min-h-screen w-full sm:grid sm:grid-cols-12 sm:grid-rows-12 sm:overflow-hidden">
        ...
        <Footter className="z-10 dark:bg-greyText dark:*:text-[white] bg-white flex justify-center items-center flex-row sm:col-span-12 sm:row-span-1 text-2xl pb-2 pt-2" />
      </div>
    </div>
  )
}
